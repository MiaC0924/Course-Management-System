...
public class ControllerTest {
    ...
    public void UserCase12() {
        ...
        boolean period = c.validRegisterPeriod(comp3005B.getTermYear(), comp3005B.getTermSeason());
        assertTrue(period);
        ...
        ArrayList<Observer> expect1 = new ArrayList<>();
        expect1.add(s1);

        assertEquals(expect1, comp3005B.getObservers());//should be only one observer;

        //Student select a course comp3004A in Course list.
        period = c.validRegisterPeriod(comp3004A.getTermYear(), comp3004A.getTermSeason());
        assertFalse(period);//this step is with-in the register;
        ...
        ArrayList<Observer> expectEmpty = new ArrayList<>();
    ...
    public void UserCase13(){
        ...
        int valid = dc.validDropPeriod(comp3004A.getTermYear(), comp3004A.getTermSeason());
        ...
        valid = dc.validDropPeriod(comp3005A.getTermYear(), comp3005A.getTermSeason());
        ...
        valid = dc.validDropPeriod(comp3005C.getTermYear(), comp3005C.getTermSeason());
        assertEquals(-1, valid);
